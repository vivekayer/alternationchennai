      ...
      <div className="prose prose-invert max-w-none text-gray-300 space-y-6">
        <div>
          ...
          <p>
            ...
            the best contemporary, jazz original and improvised music in
            Chennai. Hosted on an outdoor stage in the Zol gardens at The
            Palomar by Crossway on the East Coast Road, Chennai, the festival
            kicks off in the afternoon at 3pm, and will run all day with
            fantastic bands taking the stage up until 11pm.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            From 6pm, the three headline acts will take the stage. The first
            performance of the evening will be from Chennai-based Avant Garde
            Jazz trio, Many Things. Many Things combine jazz, rock, classical
        ...
        <div>
          ...
          <p>
            Jatayu will take the stage for the final headline of the festival.
